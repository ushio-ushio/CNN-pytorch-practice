...
class Residual(nn.Module):
    def __init__(self,input_channels,num_channels,stride=1,use_1conv=False):
        ...
        if use_1conv:
            self.conv3=nn.Conv2d(in_channels=input_channels,out_channels=num_channels,kernel_size=1,stride=stride,padding=0)
...
if __name__=="__main__":
    ...
    model=ResNet_18(Residual).to(device)
